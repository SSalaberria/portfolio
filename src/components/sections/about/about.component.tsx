...
export function About() {
  ...
  return (
    <section
      className="container flex w-full max-w-5xl flex-col items-center justify-between gap-8 md:flex-row"
      id="about"
    >
      <div>
        ...
        <p
          dangerouslySetInnerHTML={{ __html: t("sections.about.description") }}
